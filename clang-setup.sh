...
if [[ "${COMPILER_TYPES}" =~ "clang" ]]; then
	...
	git clone https://github.com/LineageOS/android_prebuilts_gcc_linux-x86_aarch64_aarch64-linux-android-4.9 -b lineage-18.1 --depth=1 "${KERNELDIR}/gcc"
        git clone https://github.com/LineageOS/android_prebuilts_gcc_linux-x86_arm_arm-linux-androideabi-4.9 -b lineage-18.1 --depth=1 "${KERNELDIR}/gcc32"
