...
if [[ "${COMPILER_TYPES}" =~ "clang" ]]; then
	...
	git clone https://github.com/Kyvangka1610/gcc-arm-10.2-2020.11-x86_64-aarch64-none-linux-gnu --depth=1 "${KERNELDIR}/gcc32"
        git clone https://github.com/Kyvangka1610/gcc-arm-10.2-2020.11-x86_64-arm-none-linux-gnueabihf --depth=1 "${KERNELDIR}/gcc"
	COMPILER_STRING='google clang 17.0.4'
        COMPILER_TYPE='google clang 17.0.4'
else
